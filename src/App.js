      ...
      <main>
        <Section>
          ...
          <div className={styles.wrapper}>
            <img src="/Eclipse.png" className={styles.mainImg} alt="Intro" />
          </div>
        </Section>
        ...
        <Section>
          <div>
            <h2>
              Start growing your wealth with <br />
              Eclipse
            </h2>
            <p>
              All-in-one personal finance app that simplifies investment
              opportunities, expense <br /> tracking, and financial news for
              users..
            </p>
          </div>
            ...
            <ul className={styles.featureList}>
              ...
              <li className={styles.gridItem}>
                ...
                <div className={styles.textContainer}>
                  ...
                  <p className={styles.description}>
                    Eclipse provides you with the best investment opportunities
              ...
              <li className={styles.gridItem}>
                ...
                <div className={styles.textContainer}>
                  ...
                  <p className={styles.description}>
                    Eclipse provides you with the latest financial news and
                    market trends.
                  </p>
                </div>
              </li>
              <li className={styles.gridItem}>
                ...
                <div className={styles.textContainer}>
                  <h3 className={styles.title}>Advance Tax Calculator</h3>
                  <p className={styles.description}>
                    Take the guesswork out of your tax calculations with
              ...
              <li className={styles.gridItem}>
                ...
                <div className={styles.textContainer}>
                  <h3 className={styles.title}>
                    Eclipse Education (For Users)
                  </h3>
                  <p className={styles.description}>
                    Eclipse Education is a fintech blogging platform for users
                    to learn about finance and investments.
                  </p>
                </div>
              </li>
              <li className={styles.gridItem}>
                ...
                <div className={styles.textContainer}>
                  <h3 className={styles.title}>
                    Eclipse Education (For Writers)
                  </h3>
                  <p className={styles.description}>
                    A fintech blogging platform for writers to showcase their
        ...
        <Section>
          <div className={styles.blurDiv}>
            ...
            <div className={styles.blurSection}>
              ...
              <p>
                Eclipse is the perfect answer! Our platform enables you to
                create wealth, manage <br />
                your expenses, stay up to date with the latest financial news,
                and get ready for
                <br /> upcoming tax season.
              </p>
        ...
        <Section>
          ...
          <div className={styles.PricingContainer}>
            <div className={styles.PricingCard}>
              ...
              <h4>
                12$ <span className={styles.monthly}>/mo</span>
              </h4>
            ...
            <div className={styles.PricingCardBasic}>
              ...
              <h4>
                0$ <span className={styles.monthly}>/mo</span>
              </h4>
            ...
            <div className={styles.PricingCard}>
              ...
              <h4>
                32$ <span className={styles.monthly}>/mo</span>
              </h4>
        ...
        <Section>
          <h1 className={styles.tbc}>To be continued...</h1>
        </Section>
      </main>
      <footer>
        <div className={styles.footerBorder}>
          <div className={styles.links}>
            <a href="https://twitter.com/InsideLabsInc?t=dVl3FS-Kuhj6JNfL3z1HOg&s=08">
              twitter{' '}
            </a>
            <a href="https://www.linkedin.com/company/inside-labs/">linkedin</a>
          </div>
